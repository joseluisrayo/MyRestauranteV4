...
public class RegistroMenu1 extends AppCompatActivity implements Entrada.Comunicador {
...
private    TextView txtarea;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle1!=null){
            String iddato=bundle1.getString("idrestaurante");
    ...
    public void enviar(String envia) {
        ...
        textView=txtarea.getText().toString();
        txtarea.setText(envia);
        Log.d("llego",envia);
